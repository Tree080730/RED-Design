...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <React.StrictMode><ConfigProvider theme={brandTheme}><AntApp><TokenProvider>{window.location.pathname.startsWith('/demo')?<DietPreferences/>:<App />}</TokenProvider></AntApp></ConfigProvider></React.StrictMode>,
);
